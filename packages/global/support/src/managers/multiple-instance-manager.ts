...
export abstract class MultipleInstanceManager<TInstance = unknown> {
   ...
   */
  public abstract getInstanceConfig(
    name: string,
  ...
  protected resolve(name: string): TInstance {
    ...
    const method =
      `create${Str.studly(driverName)}${Str.studly(this.driverKey)}` as keyof this;
    if (typeof this[method] === "function") {
      return (this[method] as (config: Record<string, unknown>) => TInstance)(
        config,
      );
    }
