...
export type { IApplicationFactoryOptions } from "./interfaces";
export {
...
// ============================================================================
// Cross-platform React bindings — pure-React hooks + context + provider.
// Live in `core/` per `.kiro/steering/subpath-layering.md` §"Where
// does a hook / context / provider go?" — the entity is pure React
// (uses `useMemo`, `useContext`, `createContext`), has zero DOM /
// RN imports, and is consumed by both `@stackra/container/react`
// AND `@stackra/container/native` (which re-export from here).
//
// `react` is declared as an OPTIONAL peer of `@stackra/container`.
// Consumers who don't compose these hooks tree-shake the imports
// out; consumers who do already provide `react` themselves.
// ============================================================================
