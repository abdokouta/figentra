...
export interface IHttpRequestConfig {
   ...
   * `isUpload` (`boolean`), `apiVersion` (`string | false` — see
   * `@stackra/versioning`; overrides the module + connection default;
   * `false` opts out entirely — the mirror of the backend's
   * `#[ApiVersionNeutral]` attribute).
   */
