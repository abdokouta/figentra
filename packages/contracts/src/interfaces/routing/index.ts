...
export type {
  ...
  IRouteMatchSpec,
  IPrerenderSpec,
} from "./route-record.interface";
export type { IRouterConfig } from "./router-config.interface";
export type {
  IRouteMetadata,
  IRouteProvider,
} from "./route-provider.interface";

// ── Native screen record + registry (RN counterpart to route) ───────
export type { IScreenRecord, IScreenKind } from "./screen-record.interface";
export type { IScreenRegistry } from "./screen-registry.interface";
export type {
  ILinkingBuilder,
  ILinkingScreensConfig,
} from "./linking-builder.interface";

// ── Module options ──────────────────────────────────────────────────
export type {
  IRoutingModuleOptions,
  IDevMode,
} from "./routing-module-options.interface";
export type { IRoutingFeatureOptions } from "./routing-feature-options.interface";
export type { INativeRoutingModuleOptions } from "./native-routing-module-options.interface";
export type { INativeRoutingFeatureOptions } from "./native-routing-feature-options.interface";
