 ...
 * @description Resolved AI runtime configuration. Authored in the
 *   consumer app via `registerAs<IAiConfig>('ai', () => ({...}))`
 *   from `@stackra/config` and passed to
 *   `AiModule.forRootAsync(aiConfig.asProvider())`.
 */
