...
import { PipelineModule } from "../../src/pipeline.module";
import { PIPELINE_FACTORY } from "../../src/constants/pipeline.constant";
import { PipelineHub } from "../../src/services/pipeline-hub.service";
import { Pipeline } from "../../src/services/pipeline.service";
...
describe("PipelineModule", () => {
  describe(".forRoot()", () => {
    ...
    it("PIPELINE_FACTORY declares APPLICATION as an optional inject", () => {
      ...
      const injectDescriptor = factoryEntry!.inject![0] as {
        token?: unknown;
        optional?: boolean;
      };
