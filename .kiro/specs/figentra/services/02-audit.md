...
Durable security/compliance audit records consumed from domain events; audit is not application logging.
...
- `plan.md`
- `src/app.module.ts`
- `src/audit/application/audit-event.consumer.ts`
- `src/audit/application/audit.service.ts`
- `src/audit/application/audit.types.ts`
- `src/audit/domain/audit-entry.entity.ts`
- `src/audit/events/audit-recorded.event.ts`
- `src/audit/presentation/audit.controller.ts`
- `src/audit/presentation/responses/audit-entry.response.ts`
- `src/database/migrations/001_create_audit_entries.ts`
