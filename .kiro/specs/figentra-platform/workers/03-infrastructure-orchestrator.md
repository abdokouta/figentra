...
**Purpose:** Controlled API for infrastructure lifecycle when orchestration is
enabled.

## Boundary

Must not own: No arbitrary Terraform execution from untrusted users; no business
data.
