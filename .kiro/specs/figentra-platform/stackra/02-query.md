# Stackra Query / server state — Kiro Usage Specification
...
Canonical frontend server-state layer **when/if the approved Stackra Query
package is introduced**: queries, mutations, cache, invalidation, pagination,
retries and optimistic updates. Do not create a second Figentra query
abstraction.
