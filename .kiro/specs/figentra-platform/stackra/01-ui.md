...
Use the existing Stackra UI primitives where they are authoritative; do not duplicate component infrastructure in Figentra. Frontend apps compose this package with HeroUI Pro and the Figentra theme/runtime contract.
