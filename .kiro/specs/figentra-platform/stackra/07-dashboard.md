# Stackra Dashboard UX — Kiro Usage Specification
...
Widget grid/layout/customization primitive. Figentra/application owns dashboard
metadata, permissions, data contracts and widget components.
