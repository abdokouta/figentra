# Events Package — Kiro Implementation Specification

**Package:** `@figentra/events`  
**Path:** `packages/events`  
**Purpose:** Versioned event envelope, event types and payload schemas.
...
**Hard rule:** must not publish or consume transport directly.
