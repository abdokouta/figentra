# IAM Contracts Package — Kiro Implementation Specification

**Package:** `@figentra/iam-contracts`  
**Path:** `packages/iam`  
**Purpose:** Authorization request/decision and permission contracts.
...
**Hard rule:** must not own IAM persistence.
