# Registry Package — Kiro Implementation Specification

**Package:** `@figentra/registry`  
**Path:** `packages/registry`  
**Purpose:** Registry API client and manifest/control-plane contracts.
...
**Hard rule:** must not become application business data.
