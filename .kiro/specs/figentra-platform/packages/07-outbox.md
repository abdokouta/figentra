# Outbox Package — Kiro Implementation Specification

**Package:** `@figentra/outbox`  
**Path:** `packages/outbox`  
**Purpose:** Transactional outbox entities/repositories/relay abstractions.
...
**Hard rule:** must not decide domain event semantics.
