# Contracts Package — Kiro Implementation Specification

**Package:** `@figentra/contracts`  
**Path:** `packages/contracts`  
**Purpose:** Canonical HTTP DTOs, OpenAPI schemas, shared contract types.
...
**Hard rule:** must not contain runtime business logic.
