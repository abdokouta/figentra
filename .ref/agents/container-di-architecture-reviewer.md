...
description: >-
  ...
  framework architecture of the stackra-frontend (@stackra/core) monorepo (root:
  /Users/akouta/Projects/stackra-frontend) — @stackra/container
...
(root: `/Users/akouta/Projects/stackra-frontend`). Read implementations deeply —
verify the code obeys the framework's own rules, not just that it compiles.
