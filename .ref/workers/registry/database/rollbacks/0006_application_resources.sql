-- =============================================================================
-- @file workers/registry/database/rollbacks/0006_application_resources.sql
-- @description Explicit rollback companion for 0006_application_resources.sql.
--
-- @operations
...
DROP TABLE IF EXISTS application_resources;
