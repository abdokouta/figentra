 ...
 * @module @stackra/nestjs-rate-limit/test
 * @description Vitest configuration for @stackra/nestjs-rate-limit.
 *
...
import { IdefineConfig, mergeConfig } from 'vitest/config';
