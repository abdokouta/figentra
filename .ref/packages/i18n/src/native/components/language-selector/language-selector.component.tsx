...
// `useI18n` is cross-platform (lives under `core/hooks/`) — import
// directly from core so this native component doesn't reach into the
// react subpath (per `.kiro/steering/subpath-layering.md`).
