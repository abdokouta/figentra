 ...
 *   truth consumed directly by services (via inline `??` fallbacks
 *   against `DEFAULT_I18N_CONFIG`) per ADR-0063.
 */
 ...
 * defaults above so services can spread it inline against caller-supplied
 * options (per ADR-0063 — no separate merge util).
 */
