...
// ════════════════════════════════════════════════════════════════════════════════
// Config factory — the framework's default `settingsConfig` factory lives at
// `packages/frontend/settings/config/settings.config.ts` (package root,
// Laravel-publishable-template convention per ADR-0063). Consumers import
// from `@stackra/settings/config` (subpath export) OR copy the file into
// their own app's `src/config/` for full customization.
// ════════════════════════════════════════════════════════════════════════════════
