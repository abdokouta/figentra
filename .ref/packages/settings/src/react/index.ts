...
export {
  SettingsGroupPage,
  SettingsHubPage,
  type ISettingsGroupPageProps,
  type ISettingsHubPageProps,
} from "./pages";

// ════════════════════════════════════════════════════════════════════════════════
// Routes
// ════════════════════════════════════════════════════════════════════════════════
// @Route()-decorated route classes — auto-discovered by
// `RouteLoader` at bootstrap.
export { SettingsGroupRoute, SettingsHubRoute } from "./routes";

// ════════════════════════════════════════════════════════════════════════════════
// Web-runtime module (adds routing on top of core)
// ════════════════════════════════════════════════════════════════════════════════
export { WebSettingsModule } from "./web-settings.module";
