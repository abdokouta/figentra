 ...
 * @description ContainerProvider Component
 *
...
import { ContainerContext } from "@/core/contexts/container";
import { getGlobalApplicationContext } from "@/core/utils/global-application.util";

/** Props for {@link ContainerProvider}. */
export interface ContainerProviderProps {
  /**
   * Application context to bind. When omitted, the provider falls back
   * to the global context registered by `ApplicationFactory.create(...)`.
   */
  context?: ApplicationContext;

  /** Subtree that gets access to `useInject(...)`. */
  children: ReactNode;
}
