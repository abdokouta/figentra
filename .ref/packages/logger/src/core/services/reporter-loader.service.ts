...
import { REPORTER_METADATA_KEY } from '../decorators/reporter.decorator';
 ...
 * `@stackra/ts-container` (browser) and NestJS (server) via the platform-agnostic
 ...
 */
@Injectable()
export class ReporterLoader implements IOnModuleInit {
  /**
