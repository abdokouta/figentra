...
import { BroadcastChannelTabTransport } from "../transports/broadcast-channel-tab.transport";
import { NoopTabTransport } from "../transports/noop-tab.transport";
 ...
 */
@Injectable()
export class TabTransportManager
  implements ITabTransportManager, OnModuleDestroy
{
