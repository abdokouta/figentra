 ...
 * @description `@HttpInterceptor()` class decorator.
 *
...
export function HttpInterceptor(
  options: IHttpInterceptorOptions = {},
): ClassDecorator {
 ...
 */
export function getHttpInterceptorMetadata(
  target: Function,
): IHttpInterceptorOptions | undefined {
  return getMetadata<IHttpInterceptorOptions>(
    HTTP_INTERCEPTOR_METADATA,
    target as object,
  );
}
