...
import type { IOnModuleInit, IOnModuleDestroy } from '@stackra/ts-container';
...
/** Minimal discovery service interface (both ts-container and NestJS provide this). */
 ...
 */
@IInjectable()
export class EventSubscribersLoader implements IOnModuleInit, IOnModuleDestroy {
  /**
   ...
   */
  public constructor(
    @Inject(EVENT_EMITTER_TOKEN) private readonly emitter: EventEmitter,
