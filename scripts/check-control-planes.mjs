#!/usr/bin/env node
/**
 * @file scripts/check-control-planes.mjs
 * @description Validates every service's control-plane surface (health, readiness endpoints).
 *
 *   Walks each service cloud.yaml, checks health and readiness paths exist.
 *
 *   Exit codes:
 *     0 — all checks pass.
...
console.log("─── check-control-planes ───");
