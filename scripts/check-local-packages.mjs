#!/usr/bin/env node
/**
 * @file scripts/check-local-packages.mjs
 * @description Validates every workspace member's package.json matches its tier shape.
 *
 *   Checks required fields per tier (publishable, private, config, app).
 *
 *   Exit codes:
 *     0 — all checks pass.
...
console.log("─── check-local-packages ───");
