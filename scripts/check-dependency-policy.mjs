#!/usr/bin/env node
/**
 * @file scripts/check-dependency-policy.mjs
 * @description Validates dependency classification (catalog: for third-party, workspace:^ for peers, workspace:* for devDeps).
 *
 *   Walks every package.json in the workspace, checks dep version shapes.
 *
 *   Exit codes:
 *     0 — all checks pass.
...
console.log("─── check-dependency-policy ───");
