 ...
 * @description Validates infrastructure contracts (Terraform, Docker, cloud.yaml consistency).
 *
 *   Checks every deployable has a cloud.yaml, Terraform validates, Docker compose generates.
 *
 *   Exit codes:
 *     0 — all checks pass.
...
console.log("─── check-infrastructure-contract ───");
