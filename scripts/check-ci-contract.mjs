#!/usr/bin/env node
/**
 * @file scripts/check-ci-contract.mjs
 * @description Validates the CI pipeline contract (.gitlab-ci.yml stages, job names, required variables).
 *
 *   Parses .gitlab-ci.yml, checks every required stage + job exists.
 *
 *   Exit codes:
 *     0 — all checks pass.
