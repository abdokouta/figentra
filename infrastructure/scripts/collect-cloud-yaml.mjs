...
// Machine-owned generated output — every consumer reads from
// infrastructure/.generated/catalog.json. Never hand-edit; regenerated by
// `pnpm run catalog` before every Terraform plan / Docker Compose generation.
const CATALOG_OUT = join(REPO_ROOT, "infrastructure", ".generated", "catalog.json");
