...
Stripe payment processing integration. Configures the Stripe API key, webhook secret, and default currency for the deployable to process payments, subscriptions, and invoices.
