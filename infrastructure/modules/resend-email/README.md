...
Resend transactional email integration. Configures the Resend API key and
default sender domain for the deployable to send transactional emails (password
