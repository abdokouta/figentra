...
Supabase PostgreSQL database. Provisions a Supabase project (or reuses an existing one) and injects the connection string, service-role key, and anon key into the deployable runtime.
