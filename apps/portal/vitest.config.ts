 ...
 * @module @figentra/portal/test
 * @description Vitest configuration for the portal SPA. Merges the
 *   workspace's canonical React preset (`@stackra/testing/preset/react`)
 *   with app-specific include patterns.
 *
