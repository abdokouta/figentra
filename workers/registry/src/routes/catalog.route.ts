...
const categories = ['event', 'workflow', 'integration', 'setting', 'feature', 'widget', 'localization'] as const;
...
export function createCatalogRoutes(): Hono<{ Bindings: RegistryBindings; Variables: RegistryVariables }> {
