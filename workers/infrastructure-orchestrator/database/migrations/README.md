...
The Infrastructure Orchestrator Worker uses **raw SQL + Wrangler D1 migrations**.

Each migration file owns **one logical table** and its directly associated
indexes. This makes schema ownership obvious, reviewable, and easy to audit.
