/**
 * Root composition module for the Figentra scope service.
 *
...
@Module({
  ...
  imports: [
    ...
    RegistryModule.forRootAsync({
      useFactory: () => ({
        application: "scope",
        displayName: "Scope Service",
        description: "Resource tenancy partitioning, organizational hierarchy, data boundaries, and context resolution.",
