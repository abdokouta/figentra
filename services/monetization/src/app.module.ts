/**
 * Root composition module for the Figentra monetization service.
 *
  ...
  imports: [
    ...
    RegistryModule.forRootAsync({
      useFactory: () => ({
        ...
        displayName: "Monetization Service",
        description: "Billing lifecycle, invoicing, Stripe/payment provider mediation, and subscription management.",
