 ...
 * @description Canonical immutable metadata for the monetization service.
 *
...
export const SERVICE_PACKAGE_NAME = "@figentra/monetization";
/** Stable service slug. */
export const SERVICE_NAME = "monetization";
