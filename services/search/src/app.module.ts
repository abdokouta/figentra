/**
 * Root composition module for the Figentra search service.
 *
  ...
  imports: [
    ...
    RegistryModule.forRootAsync({
      useFactory: () => ({
        ...
        description: "Cross-resource indexing, semantic/vector search, full-text queries, and discovery ranking.",
