/**
 * Root composition module for the Figentra integrations service.
 *
  ...
  imports: [
    ...
    RegistryModule.forRootAsync({
      useFactory: () => ({
        ...
        description: "Third-party connector execution, webhook delivery, OAuth token management, and partner APIs.",
