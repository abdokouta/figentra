 ...
 * @description Canonical immutable metadata for the integrations service.
 *
...
export const SERVICE_PACKAGE_NAME = "@figentra/integrations";
/** Stable service slug. */
export const SERVICE_NAME = "integrations";
