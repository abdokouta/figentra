 ...
 * @description Canonical immutable metadata for the entitlements service.
 *
...
export const SERVICE_PACKAGE_NAME = "@figentra/entitlements";
/** Stable service slug. */
export const SERVICE_NAME = "entitlements";
