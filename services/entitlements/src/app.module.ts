/**
 * Root composition module for the Figentra entitlements service.
 *
  ...
  imports: [
    ...
    RegistryModule.forRootAsync({
      useFactory: () => ({
        ...
        displayName: "Entitlements Service",
        description: "Subscription tier verification, feature flag gating, quota enforcement, and plan entitlements.",
