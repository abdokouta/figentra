/**
 * Root composition module for the Figentra usage service.
 *
  ...
  imports: [
    ...
    RegistryModule.forRootAsync({
      useFactory: () => ({
        ...
        description: "Metering aggregation, real-time consumption telemetry, burst tracking, and billing event recording.",
