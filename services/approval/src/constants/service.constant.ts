 ...
 * @description Canonical immutable metadata for the approval service.
 *
...
export const SERVICE_PACKAGE_NAME = "@figentra/approval";
/** Stable service slug. */
export const SERVICE_NAME = "approval";
