/**
 * Root composition module for the Figentra policy service.
 *
  ...
  imports: [
    ...
    RegistryModule.forRootAsync({
      useFactory: () => ({
        ...
        description: "Authorization policy evaluation, ABAC/RBAC rule engine, and access decision enforcement.",
