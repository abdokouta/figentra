...
Every service boundary propagates request ID, correlation ID and trace context.
Structured logs use Pino-compatible fields. Security-sensitive authorization,
identity, administrative and infrastructure mutations generate audit records.
