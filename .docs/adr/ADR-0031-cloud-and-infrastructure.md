...
Terraform provisions durable infrastructure and produces identifiers consumed
by generated runtime configuration. Secrets are injected through the approved
secret-management system and never committed to manifests.

## Consequences
The platform can use Cloudflare-native primitives without forcing every
service into a Worker runtime.
