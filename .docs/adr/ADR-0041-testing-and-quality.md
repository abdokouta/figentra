...
All artifacts use shared Stackra testing configuration where applicable.
Oxlint is the standard linter and Prettier is the formatter. ESLint and Jest
are not platform defaults.
