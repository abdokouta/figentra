...
Scope relationships and inheritance are explicitly declared rather than
inferred from arbitrary database nesting.
...
## Consequences
Different SaaS applications can model different hierarchies without changing
the core IAM architecture.
