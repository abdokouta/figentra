...
boundary. Hono itself remains the routing engine; no additional router
...
must have useful documentation. Non-trivial private members and contract
members are also documented.
...
analysis and AI-agent navigation without forcing meaningless comments on
