...
mutation and outbox record are committed atomically in the service database. A
relay publishes committed records to NATS JetStream and tracks attempts.
...
Database state and published intent cannot silently diverge because of a publish
failure.
