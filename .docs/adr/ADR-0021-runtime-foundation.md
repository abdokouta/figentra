...
Figentra backend services use Node.js 24 LTS, NestJS, Fastify, SWC, Pino,
Vitest, Oxlint, Prettier, and validated configuration. NestJS HTTP services use
the Fastify adapter. `main.ts` is the standard process entrypoint; separate
