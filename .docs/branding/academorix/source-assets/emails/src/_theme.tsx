/**
 * @file _theme.tsx
 * @module @academorix/email-templates/_theme
 * @description Shared tokens + primitive components for every
 *   Academorix React Email template.
 *
 *   Never renders on its own (leading underscore excludes it from the
 *   `email dev` preview server). Consumed by welcome.tsx,
 *   session-reminder.tsx, invoice.tsx, newsletter.tsx.
 *
 *   If a token drifts from the Sprint 1 rebind (../../_shared/tokens.css
 *   + ../../../academorix-brand-system.html), Sprint 1 wins — fix here.
 */
...
export const theme = {
  ...
  signal100: "#ffd9c4",
  signal700: "#d14a1a",
  signalTint: "rgba(255, 107, 53, 0.08)",
...
/* ── logo mark · inline SVG · always renders in every client ── */
export function LogoMark({
  ...
  return (
    <Img
      src="https://academorix.com/mark-inline.svg"
      alt="Academorix"
      width={size}
      height={size}
      style={{ display: "block" }}
...
/* ── shared shell · every template wraps its <Container> in this ── */
  ...
  return (
    <Html lang="en">
      ...
      >
        ...
        >
          {/* ── header · A-Chevron mark · dark strip ── */}
          <Section
            style={{
...
/* ── mono chip · used for tokens, session codes, invoice #s ── */
...
/* ── chevron divider ─────────────────────────────────────── */
export function ChevronDivider(): React.ReactElement {
  return (
...
export function EmailFooter(): React.ReactElement {
  return (
    ...
    >
      ...
      >
        Academorix · a Figentra L.L.C product
      </Text>
      <Text
        style={{
          margin: "0 0 12px",
      ...
      >
        ...
        {" · "}
        <Link
          href="https://academorix.com/legal/privacy"
          style={{ color: theme.textMuted, textDecoration: "underline" }}
        >
          Privacy
        </Link>
        {" · "}
        <Link
          href="https://academorix.com/trust/minors"
          style={{ color: theme.textMuted, textDecoration: "underline" }}
        >
          Minor consent
        </Link>
