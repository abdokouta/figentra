# Brand & Website Review — Final Direction
...
- explicit favicon/icon source-of-truth rules;
- distinct design systems per product;
- production release gates.

## Favicon/icon correction

The canonical rule is now:

```text
One approved master mark
        ↓
SVG
        ↓
favicon
...
Figentra uses the canonical F-Cursor mark.

Academorix uses its own approved product mark.
