...
Use explicit `.route.ts` modules per cohesive HTTP boundary as defined in `worker-route-standard.md`. Hono remains the router; do not add another routing framework.
